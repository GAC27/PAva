...
public abstract class FunctionHandler {
	 ...
	 * @return
	 */
	protected ArrayList<GFMethod> sortMethods(int indexArg, ArrayList<GFMethod> gfMethods, ArrayList<Class> argsType)
	{
	 ...
	 protected ArrayList<GFMethod> getAplicableMethods(ArrayList<Class> argsType, ArrayList<GFMethod> gfMethods){
		boolean isAplicable;
